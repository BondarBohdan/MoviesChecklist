...
<ul class="nav nav-pills categories" style="font-size:25px;">
    ...
    <li class="active"><a href="${ServletURL.SETTINGS.getUrl()}" data-bs-hover-animate="pulse"><c:out
            value="${settingsText}"/></a></li>
...
<div class="contact-clean">
    <form method="post" action="/MoviesChecklistEE_war_exploded/settings">
        ...
        <div class="form-group"><input class="form-control" type="text" name="surname" placeholder="Surname"
                                       value="${user.getSurname()}"></div>
        <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"
                                       pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="${user.getEmail()}">
        </div>
        <div class="form-group">
            <button class="btn btn-primary center-block" type="submit">UPDATE</button>
        </div>
    </form>
</div>
<footer>
