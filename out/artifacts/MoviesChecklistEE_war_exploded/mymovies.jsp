...
<ul class="nav nav-pills categories">
    <li class="active"><a href="/MoviesChecklistEE_war_exploded/mymovies" data-bs-hover-animate="pulse">My Movies</a>
    </li>
    <li><a href="/MoviesChecklistEE_war_exploded/library" data-bs-hover-animate="pulse">Library</a></li>
